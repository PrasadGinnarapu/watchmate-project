...
class MovieSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        # fields = ['id','name','description']   #we can specify what are the fields we want
        # exclude = ['active']   #To exclude specific field/s
    
    
    
    #if we do with ModelSerializer we have to specify validations like below (Field level and Object level)
